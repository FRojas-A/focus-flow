...
const Tile = React.forwardRef<HTMLDivElement, TileProps>(
    ...
    <div 
        ref={ref} 
        className={cn("flex w-full min-h-16 bg-white shadow-md shadow-black/20 hover:shadow-lg hover:shadow-black/30 transition-all duration-75 hover:scale-105 ", className)}
    >
